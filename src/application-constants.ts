...
export const GITHUB_ISSUES_CREATE_LOG_INFO_FOR_PR_SCANS = 'Creating GitHub issues are ignored for pull request scan'
...
export const GITHUB_TOKEN_VALIDATION_ISSUE_CREATE_ERROR = 'Missing required GitHub token for creating issues in GitHub'
export const SARIF_CREATE_VALIDATION_ISSUE_CREATE_ERROR = 'SARIF report creation must be enabled for creating issues in GitHub'
