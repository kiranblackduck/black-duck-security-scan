...
export const NETWORK_SSL_VALIDATION_MESSAGE = 'Both network_ssl_cert_file and network_ssl_trustAll are set. Only one of these resources should be set at a time.'
