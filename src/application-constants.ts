...
export const INTEGRATION_LOCAL_DIRECTORY = '.blackduck/integrations'
export const BLACKDUCK_SARIF_GENERATOR_DIRECTORY = 'Blackduck SCA SARIF Generator'
export const INTEGRATION_BLACKDUCK_SARIF_GENERATOR_DIRECTORY = '/blackducksca/sarif'
...
export const INTEGRATION_POLARIS_SARIF_GENERATOR_DIRECTORY = '/polaris/sarif'
...
export const INTEGRATION_POLARIS_DEFAULT_SARIF_FILE_PATH = '.blackduck/integrations/polaris/sarif'
export const INTEGRATION_BLACKDUCK_SCA_DEFAULT_SARIF_FILE_PATH = '.blackduck/integrations/blackducksca/sarif'
