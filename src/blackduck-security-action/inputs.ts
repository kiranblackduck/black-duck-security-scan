...
export const POLARIS_REPORTS_SARIF_FILE_PATH = getInput(constants.POLARIS_REPORTS_SARIF_FILE_PATH_KEY)?.trim() || constants.INTEGRATION_POLARIS_DEFAULT_SARIF_FILE_PATH.trim()
