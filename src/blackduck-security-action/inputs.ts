...
export const POLARIS_REPORTS_SARIF_FILE_PATH = getInput(constants.POLARIS_REPORTS_SARIF_FILE_PATH_KEY)?.trim() || constants.INTEGRATIONS_POLARIS_DEFAULT_SARIF_FILE_PATH
...
export const BLACKDUCKSCA_REPORTS_SARIF_FILE_PATH = getInput(constants.BLACKDUCKSCA_REPORTS_SARIF_FILE_PATH_KEY)?.trim() || getInput(constants.BLACKDUCK_REPORTS_SARIF_FILE_PATH_KEY)?.trim() || constants.INTEGRATIONS_BLACKDUCK_SCA_DEFAULT_SARIF_FILE_PATH
