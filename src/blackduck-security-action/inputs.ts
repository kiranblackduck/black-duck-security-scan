...
export const BLACKDUCKSCA_REPORTS_SARIF_FILE_PATH = getInput(constants.BLACKDUCKSCA_REPORTS_SARIF_FILE_PATH_KEY)?.trim() || getInput(constants.BLACKDUCK_REPORTS_SARIF_FILE_PATH_KEY)?.trim() || constants.INTEGRATION_POLARIS_DEFAULT_SARIF_FILE_PATH
