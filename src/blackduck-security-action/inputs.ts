...
export const POLARIS_ISSUES_CREATE_ENABLED = getInput(constants.POLARIS_ISSUES_CREATE_ENABLED_KEY)?.trim() || ''
...
export const BLACKDUCKSCA_ISSUES_CREATE_ENABLED = getInput(constants.BLACKDUCKSCA_ISSUES_CREATE_ENABLED_KEY)?.trim() || ''
